			...
			fields: [
				...
				},
				{
					...
					type: {
						...
						loc: { start: 1283, end: 1292 },
					},
					directives: [],
					loc: { start: 1272, end: 1292 },
				},
				{
					kind: "FieldDefinition",
					name: {
				...
				},
				{
					...
					type: {
						...
						loc: { start: 1330, end: 1341 },
					},
					directives: [],
					loc: { start: 1318, end: 1341 },
				},
			],
			loc: { start: 1173, end: 1343 },
		},
		{
			kind: "ObjectTypeDefinition",
			name: {
			...
			fields: [
				{
					...
					type: {
						...
						loc: { start: 1423, end: 1431 },
					},
					directives: [],
					loc: { start: 1414, end: 1431 },
				},
			],
			loc: { start: 1390, end: 1433 },
		},
		{
			kind: "UnionTypeDefinition",
			name: {
			...
			types: [
				...
				},
				{
					...
					name: {
						kind: "Name",
						value: "ProductNotFound",
						loc: { start: 1474, end: 1489 },
					},
					loc: { start: 1474, end: 1489 },
				},
			],
			loc: { start: 1435, end: 1489 },
		},
	],
	loc: { start: 0, end: 1490 },
